...
namespace twoloop
{
    public class OSStartAdjuster : OSNetTransformBase
    {
        [SyncVar] private OriginShift.AbsolutePosition absolutePosition;
        ...
        public void Awake()
        {
            if (NetworkServer.active)
            {
                this.absolutePosition =
                    new OriginShift.AbsolutePosition(OriginShift.LocalOffset, transform.position);
