...
namespace twoloop
{
    public class OSNetRigidbody : OSNetTransformBase
    {
        /// <summary>
        ...
        public override void OnStartClient()
        {
            ...
            {
                CmdInitializeOffset(new NetRbTargetData(OriginShift.LocalOffset, transform.position, transform.rotation,
        ...
        public override void OnStartServer()
        {
            ...
            if (!clientAuthority)
            {
                ServerInitializeOffset(new NetRbTargetData(OriginShift.LocalOffset, transform.position, transform.rotation,
                    true, targetRb.velocity));
            }
        }
        ...
        private void SendToServer()
        {
            ...
            if (now > _nextSyncTime)
            {
                ...
                var newData = new NetRbTargetData(OriginShift.LocalOffset, transform.position, transform.rotation,
                    IsOffsetChanged(),
                    targetRb.velocity);
    ...
    public struct NetRbTargetData
    {
        ...
        public NetRbTargetData(OriginShift.Offset offset, Vector3 remotePosition, Quaternion rotation,
